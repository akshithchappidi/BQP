...
const AboutComponent = () => {
  return (
    <div className="flex flex-col md:flex-row items-center justify-center md:mt-12">
      ...
      <div className="md:w-1/2 p-16 rounded-lg z-4 text-blue md:order-1">
        ...
        <p className="text-2xl text-white font-serif mt-4">
         ...
         <GradientText gradient='from-green-600 to-yellow-400'>Textslashing months off development cycles and saving millions.
